...
from utilidades import leitura_de_dados, COMISSÃO
...
df_vendas['comissao'] = df_vendas['preco']*COMISSÃO
...
colunas_selecionados = st.sidebar.multiselect('Selecione as colunas',
                                              col_analises_exc)

valor_selecionado = st.sidebar.selectbox('Selecione o valor da análise',
                                           COLUNAS_VALOR)
